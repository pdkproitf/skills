...
High-level patterns defining a system's overall structure. These are the most expensive to
adopt and the most expensive to reverse — recommend one only when the codebase is already
