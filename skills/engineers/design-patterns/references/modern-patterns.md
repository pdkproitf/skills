...
Patterns that emerged after the original GoF catalog — common in distributed and enterprise
systems. Most of these buy resilience or decoupling at the cost of moving failure modes
somewhere less obvious, so read **When NOT to apply** before recommending one.
